...
## Log in/out, Sign up (Feature mostly developed by He Yixin, UI mostly developed by Lin Youguang)
...
## Bottom Navigation (Mostly by He Yixin)
...
## Fetch Friends (Mostly by He Yixin)
...
## Fetch Account Information (Mostly by He Yixin)
...
## Red Envelope (Mostly developed by He Yixin)
